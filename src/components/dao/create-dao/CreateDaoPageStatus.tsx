    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-5">
          <SelectBlockchain
            current={step == 1 && router.pathname == createDaoStepNavigation[0] ? true : false}
          />
          <AboutDao
            current={step == 2 && router.pathname == createDaoStepNavigation[1] ? true : false}
          />
          <ConnectLensProfile
            current={
              (step == 3 && router.pathname == createDaoStepNavigation[2]) ||
              router.pathname == createDaoStepNavigation[4]
                ? true
                : false
            }
          />
          <Governance
            current={step == 4 && router.pathname == createDaoStepNavigation[3] ? true : false}
          />
        </div>
      </div>
    </div>
