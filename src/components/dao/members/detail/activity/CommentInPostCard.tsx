    ...
    <div className="w-full space-y-2">
      <div className="flex items-center space-x-2.5">
        ...
        <div className="flex items-center space-x-0.5">
          ...
          <div>
            <p className="text-xs text-medium-gray">comment</p>
          </div>
        </div>
      </div>
      <div className="flex space-x-5">
        <div className="flex flex-1 items-center space-x-5">
          ...
          <div className="flex-1">
            <p className="text-base font-medium text-lighter-gray">
              {truncateAddress("0xA3Db2Cb625bAe87D12AD769C47791a04BA1e5b29")}
            </p>
            <div className="flex items-center space-x-1.5">
              ...
              <div>
                <p className="text-xs text-medium-gray">March 22</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        <p className="rounded-lg bg-gray-border p-4 text-xs text-light-black">
          {truncate(
