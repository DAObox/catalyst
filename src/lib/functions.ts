...
export const handleCreateNewField = (
...
export const handleInputTypeNameChange = (
...
export const handleInputTypeUrlChange = (
  e: React.ChangeEvent<HTMLInputElement>,
  linksField: LinkFieldType[],
  index: number,
  setLinksField: SetterOrUpdater<LinkFieldType[]>,
...
export const handleInputTypeTitleChange = (
  e: React.ChangeEvent<HTMLInputElement>,
...
export const handleInputTypeDescriptionChange = (
...
export function setCreateDaoData(
  ...
  setCreateDao: SetterOrUpdater<CreateDaoType>
) {
